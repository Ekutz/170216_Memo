...
import static com.jspark.android.bbsbasic.MainActivity.REQ_CAMERA;
import static com.jspark.android.bbsbasic.MainActivity.REQ_GALLERY;
...
public class DetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(view==null) {
            ...
            imgThumb.setImageResource(R.drawable.default_camera);
            editTitle.setText("");
            editContent.setText("");
    ...
    public void onResume() {
        super.onResume();
        Glide.with(context).load(fileUri).placeholder(R.drawable.default_camera).into(imgThumb);
